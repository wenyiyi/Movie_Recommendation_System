...
#username_suggestion { display: inline-block; position: absolute; left: 305px; top: 2px; _left: 0px }
#username_suggestion p { background: #eef9eb; border: 1px solid #5e5e5f; margin: 0; padding: 3px }
#password_suggestion { display: inline-block; position: absolute; left: 305px; top: 50px; _left: 0px }
#password_suggestion p { background: #eef9eb; border: 1px solid #5e5e5f; margin: 0; padding: 3px }
...
<script type="text/javascript">
	$(document).ready(function(){
	  $("#username").focus(function(){
		  $("#username_suggestion").html("6-10个数字或字母，字母区分大小写");
	  });
	  
	  $("#username").blur(function(){
		  $("#username_suggestion").hide();
	  });
	  
	  $("#password").focus(function(){
		  $("#password_suggestion").html("6-16个字符组成，区分大小写");
	  });
	  
	  $("#password").blur(function(){
		  $("#password_suggestion").hide();
	  });
...
欢迎加入时光机
    ...
    <form name="lzform" method="post" action="user_register">
        <div style="display:none;">
            <input type="hidden" name="source" value="movie"/>
            <input type="hidden" name="redir" value="  "/>
        </div>
        <div class="item extra-tips">
            <label>账号</label>
            <input id="username" name="username" type="text" class="basic-input" maxlength="60" tabindex="1" value=""/>
        </div>
        <div class="suggestion">
            <div id="username_suggestion"></div>
        </div>
        <div class="item extra-tips">
            <label>密码</label>
        ...
        <div class="suggestion">
            <div id="password_suggestion"></div>
        </div>
        <div class="item extra-tips">
            <label>名号</label>
...
<ul class="sidenav">
  <li>&gt;&nbsp;已经拥有时光机帐号? <a rel="nofollow" href="user_login">直接登录</a></li>
</ul>
